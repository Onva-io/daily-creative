...
open class RequestBuilder<T>: @unchecked Sendable {
    ...
    required public init(method: String, URLString: String, parameters: [String: Any]?, headers: [String: String] = [:], requiresAuthentication: Bool) {
        ...
        addHeaders(DailyCreativeAPIAPI.customHeaders)
        addCredential()
    }
    ...
    @discardableResult
    open func execute(_ apiResponseQueue: DispatchQueue = DailyCreativeAPIAPI.apiResponseQueue, _ completion: @escaping (_ result: Swift.Result<Response<T>, ErrorResponse>) -> Void) -> RequestTask {
        return requestTask
    }
    ...
    open func addCredential() {
        credential = DailyCreativeAPIAPI.credential
    }
}
