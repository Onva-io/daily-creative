//
// CreateStorySessionRequest.swift
//
...
/** Authenticated Story Session create payload. Countdown mode requires selected_timer_seconds in {60, 180, 300, 600}. No-timer mode requires selected_timer_seconds to be null.  */
public struct CreateStorySessionRequest: Codable, JSONEncodable, Hashable {
